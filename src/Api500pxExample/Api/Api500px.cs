...
namespace Api500pxExample.Api
{
    ...
    public class Api500px 
    {
        ...
        public Api500px(OauthToken accessToken)
        {
        ...
        public async Task<GetPhotosResponse> Photos(string parameters)
        {
            ...
            var response = await Sign(url, Constants.ConsumerSecret, _accessToken.Secret, "GET", parameters).GetRequest(url, parameters);
